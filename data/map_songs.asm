MapSongBanks:
	...
	db MUSIC_CELADON, 0 ; CeladonMansion4
	...
	db MUSIC_ROUTES3, 0 ; ROUTE_19_GATE
	db MUSIC_ROUTES3, 0 ; BeachHouse
	db MUSIC_DUNGEON1, 0
	...
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneEast
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneNorth
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneWest
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneCenter
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneRestHouse1
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneSecretHouse
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneRestHouse2
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneRestHouse3
	db MUSIC_SAFARI_ZONE, 0 ; SafariZoneRestHouse4
