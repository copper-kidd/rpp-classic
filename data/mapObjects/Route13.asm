Route13Object:
	...
	object SPRITE_LASS, 48, 10, STAY, DOWN, 2, JR_TRAINER_F, 12
	object SPRITE_LASS, 27, 9, STAY, DOWN, 3, JR_TRAINER_F, 13
	object SPRITE_LASS, 23, 10, STAY, LEFT, 4, JR_TRAINER_F, 14
	object SPRITE_LASS, 50, 5, STAY, DOWN, 5, JR_TRAINER_F, 15
