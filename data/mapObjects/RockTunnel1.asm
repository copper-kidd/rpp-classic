RockTunnel1Object:
	...
	object SPRITE_LASS, 37, 21, STAY, LEFT, 5, JR_TRAINER_F, 17
	object SPRITE_LASS, 22, 24, STAY, DOWN, 6, JR_TRAINER_F, 18
	object SPRITE_LASS, 32, 24, STAY, RIGHT, 7, JR_TRAINER_F, 19
