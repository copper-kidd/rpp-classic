CinnabarGymObject:
	...
	object SPRITE_BLACK_HAIR_BOY_2, 17, 2, STAY, DOWN, 2, SUPER_NERD, 9
	object SPRITE_BLACK_HAIR_BOY_2, 17, 8, STAY, DOWN, 3, BURGLAR, 4
	object SPRITE_BLACK_HAIR_BOY_2, 11, 4, STAY, DOWN, 4, SUPER_NERD, 10
	object SPRITE_BLACK_HAIR_BOY_2, 11, 8, STAY, DOWN, 5, BURGLAR, 5
	object SPRITE_BLACK_HAIR_BOY_2, 11, 14, STAY, DOWN, 6, SUPER_NERD, 11
	object SPRITE_BLACK_HAIR_BOY_2, 3, 14, STAY, DOWN, 7, BURGLAR, 6
	object SPRITE_BLACK_HAIR_BOY_2, 3, 8, STAY, DOWN, 8, SUPER_NERD, 12
