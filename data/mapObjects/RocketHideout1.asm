RocketHideout1Object:
	...
	db $7 ; objects
	object SPRITE_ROCKET_F, $1a, $8, STAY, LEFT, $1, ROCKET_F, $8
	object SPRITE_ROCKET, $c, $6, STAY, RIGHT, $2, ROCKET, $9
	object SPRITE_ROCKET_F, $12, $11, STAY, DOWN, $3, ROCKET_F, $a
	object SPRITE_ROCKET_F, $f, $19, STAY, RIGHT, $4, ROCKET_F, $b
