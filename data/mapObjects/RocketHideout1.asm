RocketHideout1Object:
	...
	db 7 ; objects
	object SPRITE_ROCKET_F, 26, 8, STAY, LEFT, 1, ROCKET_F, 8
	object SPRITE_ROCKET, 12, 6, STAY, RIGHT, 2, ROCKET, 9
	object SPRITE_ROCKET_F, 18, 17, STAY, DOWN, 3, ROCKET_F, 10
	object SPRITE_ROCKET_F, 15, 25, STAY, RIGHT, 4, ROCKET_F, 11
