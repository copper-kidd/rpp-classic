SaffronGymObject:
	...
	db 9 ; objects
	object SPRITE_SABRINA, 9, 8, STAY, DOWN, 1, SABRINA, 1
	object SPRITE_MEDIUM, 10, 1, STAY, DOWN, 2, HEX_MANIAC, 1
	object SPRITE_BUG_CATCHER, 17, 1, STAY, DOWN, 3, PSYCHIC_TR, 1
	object SPRITE_MEDIUM, 3, 7, STAY, DOWN, 4, HEX_MANIAC, 2
	object SPRITE_BUG_CATCHER, 17, 7, STAY, DOWN, 5, PSYCHIC_TR, 2
	object SPRITE_MEDIUM, 3, 13, STAY, DOWN, 6, HEX_MANIAC, 3
