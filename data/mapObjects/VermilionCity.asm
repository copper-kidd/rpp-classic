VermilionCityObject:
	...
	warp 19, 29, 0, VERMILION_DOCK
	warp 20, 29, 0, VERMILION_DOCK
	warp 15, 13, 0, VERMILION_HOUSE_3
	warp  7,  3, 0, VERMILION_HOUSE_2
	warp  9, 29, 0, VERMILION_FERRY_DOCK
	warp 10, 29, 1, VERMILION_FERRY_DOCK
	...
	warp_to 19, 29, VERMILION_CITY_WIDTH ; VERMILION_DOCK
	warp_to 20, 29, VERMILION_CITY_WIDTH ; VERMILION_DOCK
	warp_to 15, 13, VERMILION_CITY_WIDTH ; VERMILION_HOUSE_3
	warp_to  7,  3, VERMILION_CITY_WIDTH ; VERMILION_HOUSE_2
	warp_to  9, 29, VERMILION_CITY_WIDTH ; VERMILION_FERRY_DOCK
	warp_to 10, 29, VERMILION_CITY_WIDTH ; VERMILION_FERRY_DOCK
