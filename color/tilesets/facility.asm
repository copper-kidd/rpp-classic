	...
	tilepal 0, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN
	tilepal 0, GRAY, GRAY, RED, WATER, GRAY, GRAY, BROWN, GRAY
	...
	tilepal 0, BROWN, BROWN, RED, GRAY, BROWN, BROWN, WATER, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, BROWN
	tilepal 0, BROWN, BROWN, RED, BROWN, BROWN, RED, GRAY, WATER
	tilepal 0, GRAY, WATER, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY
